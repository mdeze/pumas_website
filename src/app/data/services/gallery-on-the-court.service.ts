...
export class GalleryOnTheCourtService {
    ...
    getGalleryOnTheCourtByYear(year: number): Promise<GalleryItem[]> {
        ...
        switch (year) {
            case 2019:
                galleryURL = '/assets/content/gallery/on-the-court/gallery-on-the-court-2019.data.json';
                break;
            case 2018:
                galleryURL = '/assets/content/gallery/on-the-court/gallery-on-the-court-2018.data.json';
                break;
            case 2017:
